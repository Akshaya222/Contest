...
export default function Privacy(){
	return(
	  <div style={{width:'80vw',marginLeft:'1rem',marginBottom:'5rem'}}>
		...
		<p style={{marginTop:'2rem'}} >Website (www.onlinemic.in)’s Privacy Policy given:</p>
		<p>The terms "We" / "Us" / "Our"/ “Company” individually and collectively refer to “MIC” a unit of company “Admere Selvyn Private Limited” and the terms "You" / "Your" / "Yourself" refer to the users.</p>
		...
		<p>This Privacy Policy is a legally binding document between you and “MIC” (both terms defined below). The terms of this Privacy Policy will be effective upon your acceptance of the same (directly or indirectly in electronic form, by clicking on the I accept tab or by use of the website or by other means) and will govern the relationship between you and “MIC” for your use of the website “Website” (defined below).</p>
		<p>This document is published and shall be construed in accordance with the provisions of the Information Technology (reasonable security practices and procedures and sensitive personal data of information) rules, 2011 under Information Technology Act, 2000; that require publishing of the Privacy Policy for collection, use, storage and transfer of sensitive personal data or information.</p>
		<p>Please read this Privacy Policy carefully by using the Website, you indicate that you understand, agree and consent to this Privacy Policy. If you do not agree with the terms of this Privacy Policy, please do not use this Website.
		...
		<p>To avail certain services on our Websites, users are required to provide certain information for the registration process namely: - a) name, b) email address, c) sex, d) age, e) PIN code, f) credit card or debit card details
		g) medical records and history h) sexual orientation, i) biometric information, j) password etc., and / or your occupation, interests, and the like. The Information as supplied by the users enables us to improve our sites and provide you the most user-friendly experience.
		</p>
	   ...
	   <p>We take appropriate security measures to protect against unauthorized access to or unauthorized alteration, disclosure or destruction of data. These include internal reviews of our data collection, storage and processing practices and security measures, including appropriate encryption and physical security measures to guard against unauthorized access to systems where we store personal data.</p>
		...
		<p>Redressal Mechanism: Any complaints, abuse or concerns with regards to content and or comment or breach of these terms shall be immediately informed to the designated Grievance Officer as mentioned below via in writing or through email signed with the electronic signature to Reetesh Aanand. ("Grievance Officer").</p>
		<br/><br/>
		
		<p>Mr. Reetesh Aanand (Grievance Officer)</p>
		<p>Website: www.onlinemic.in</p>
		<p>Company Name: Admere Selvyn Private Limited</p>
		<p>Address: 156, Admere Villa, Kusum Vihar, Koyla Nagar, Dhanbad (JH) - 826005</p>
		<p>Email: care@onlinemic.in</p>
		<p>Phone: +91-9430177775</p>
	</div>
	)
}